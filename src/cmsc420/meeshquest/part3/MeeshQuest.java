...
public class MeeshQuest {
    ...
    public static void main(String[] args) {
		...
		if (LOCAL_TEST) {
			File[] files = new File("testfiles/part3Tests").listFiles();
...
//				}
    ...
    public void processInput() {
        try {
			...
			if (LOCAL_TEST) {
				System.out.println("Open " + "part3." + testName);
				xmlInput = new File("testfiles/part3Tests/" + testName + ".input.xml");
			}
			...
			if (LOCAL_TEST) {
				try {
					...
					//xmlOutput = new File("testfiles/part3Tests/" + testName + ".output.xml");
